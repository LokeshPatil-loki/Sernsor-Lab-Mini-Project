 ...
 */
 #define RAW_DATA_LEN 50
uint16_t rawDataOn [RAW_DATA_LEN]={
 2622, 918, 426, 462, 426, 462, 430, 902, 
  426, 910, 874, 466, 426, 462, 426, 462, 
  426, 462, 430, 458, 430, 458, 430, 462, 
  426, 462, 426, 462, 430, 458, 430, 458, 
  430, 462, 426, 462, 430, 458, 430, 458, 
  430, 462, 870, 458, 430, 902, 430, 458, 
  430, 1000};

#define RAW_DATA_LEN 100
uint16_t rawDataVolumeDown [RAW_DATA_LEN]={
  65506, 66, 3886, 66, 3962, 66, 65502, 498, 
  65502, 2054, 65502, 66, 394, 66, 1954, 66, 
  65502, 498, 65502, 2054, 65502, 66, 398, 62, 
  1958, 66, 65502, 494, 978, 66, 65506, 490, 
  65506, 1062, 65506, 66, 390, 66, 1958, 66, 
  65502, 490, 65506, 1062, 65502, 66, 394, 66, 
  1958, 66, 65502, 490, 1978, 62, 65506, 490, 
  65502, 2058, 65502, 66, 394, 66, 966, 66, 
  65502, 490, 65502, 1066, 65502, 66, 390, 66, 
  966, 66, 65502, 490, 65506, 1066, 65502, 66, 
  390, 66, 966, 66, 65502, 490, 65502, 2062, 
  65502, 66, 390, 66, 1962, 66, 65502, 490, 
  65502, 1066, 65502, 1000};

   
void loop() {
  mySender.send(rawDataOn,RAW_DATA_LEN,(unsigned int) 48);//Pass the buffer,length, optionally frequency
  delay(2000);
}
